...
my $parser = Lingua::FreeLing2::ChartParser->new("es");

# defined
ok     $parser => "We have a parser";
isa_ok $parser => 'Lingua::FreeLing2::ChartParser';
isa_ok $parser => 'Lingua::FreeLing2::Bindings::chart_parser';
...
ok $sentences->[0]->is_parsed;

my $ptree = $sentences->[0]->parse_tree;
isa_ok $ptree => 'Lingua::FreeLing2::ParseTree';
