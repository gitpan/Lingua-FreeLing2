...
*elements = *Lingua::FreeLing2::Bindingsc::ListWord_elements;
*get = *Lingua::FreeLing2::Bindingsc::ListWord_get;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*elements = *Lingua::FreeLing2::Bindingsc::ListAnalysis_elements;
*get = *Lingua::FreeLing2::Bindingsc::ListAnalysis_get;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*elements = *Lingua::FreeLing2::Bindingsc::ListSentence_elements;
*get = *Lingua::FreeLing2::Bindingsc::ListSentence_get;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*elements = *Lingua::FreeLing2::Bindingsc::ListParagraph_elements;
*get = *Lingua::FreeLing2::Bindingsc::ListParagraph_get;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*elements = *Lingua::FreeLing2::Bindingsc::ListString_elements;
*get = *Lingua::FreeLing2::Bindingsc::ListString_get;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*elements = *Lingua::FreeLing2::Bindingsc::ListInt_elements;
*get = *Lingua::FreeLing2::Bindingsc::ListInt_get;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*my_analyze = *Lingua::FreeLing2::Bindingsc::dep_txala_my_analyze;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
