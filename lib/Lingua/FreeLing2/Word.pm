...
use parent -norequire, 'Lingua::FreeLing2::Bindings::word';
...
The C<new> constructor returns a new C<Lingua::FreeLing2::Word>
...
of feature structures), instead of L<Lingua::FreeLing2::Word::Analysis>
objects.
...
sub analysis {
    ...
    for (@$analysis_list) {
        $_ = Lingua::FreeLing2::Word::Analysis->_new_from_binding($_);
