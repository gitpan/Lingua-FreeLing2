package Lingua::FreeLing2::HMMTagger;
...
use parent -norequire, 'Lingua::FreeLing2::Bindings::hmm_tagger';
...
Lingua::FreeLing2::HMMTagger - Interface to FreeLing2 HMMTagger

=head1 SYNOPSIS

   use Lingua::FreeLing2::HMMTagger;

   my $pt_tagger = Lingua::FreeLing2::HMMTagger->new("pt");

   # alternativelly
   my $pt_tagger = Lingua::FreeLing2::HMMTagger->new(
...
Interface to the FreeLing2 hmm tagger library.
